...
<div class="col-12">
	<div class="home default overflowXAuto">
		...
		<a href="<?= config::base_url('admin/index.php?ref=add_wali_kelas'); ?>" class="button green"><span
		...
		<table id="example" class="table table-striped" style="width:100%">
			...
			?>
				<tr class="jmlTr">
					<td><a id="delete" wali_kelas_id="<?= $r['wali_kelas_id']; ?>"><span
								class="fa fa-trash-o fa-lg"></span></a></td>
					<td><a
							href="<?= config::base_url('admin/index.php?ref=edit_wali_kelas&wali_kelas_id='.$r['wali_kelas_id']); ?>"><span
								...
								$.ajax({
									...
									success: function (respon) {
										...
										if (data != undefined && data.success != undefined) {
											...
											$("span#jmlSiswa").text(document.querySelectorAll(
												"tr.jmlTr").length + " Wali kelas");
										} else {
